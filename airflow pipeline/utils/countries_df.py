...
# removing years from column names and fixing spelling mistakes
...
# removing unneeded extra columns
...
#impute the missing values by the average of the region the country belongs to
