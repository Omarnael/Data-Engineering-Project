...
# drop all columns that are irrelevant to our analysis
...
# add missing years if life expectancy dataset
...
# impute the values of missing years added to life expectancy dataset
...
# select rows from life expectancy dataset that correspond to the recent years only
...
# merge the three datasets together into one final dataset
...
# impute missing values in final dataset using iterative imputer
...
# normalize features using minmax_scale function
